...
public class ColleageAdapter extends RecyclerView.Adapter<ColleageAdapter.VH> {
    ...
    public ColleageAdapter(Context context) {
        mInflater = LayoutInflater.from(context);
    }

    @Override
    public ColleageAdapter.VH onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_zhihu_home_first, parent, false);
        final ColleageAdapter.VH holder = new ColleageAdapter.VH(view);
    ...
    @Override
    public void onBindViewHolder(ColleageAdapter.VH holder, int position) {
